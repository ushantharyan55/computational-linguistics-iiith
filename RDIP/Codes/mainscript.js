var Engdata = [["John ate an apple before afternoon","before afternoon John ate an apple","John before afternoon ate an apple"],
...
var Hindata = [["राम और श्याम बाजार गयें","राम और श्याम गयें बाजार","बाजार गयें राम और श्याम","गयें बाजार राम और श्याम"],
...
function Sentenceformation(id,value){
	...
	reform.innerHTML = "<center><button id='refornbtn' onclick='Reformsen()'>Re-form the sentence</button></center>"
	clickcount++;
...
function dropdownoptions(){
	...
	if(x == 'english'){
		...
		for(i=0;i<=j.length-1;i++){
			val = j[i];
			b = "  <button id='btn"+i+"'onclick='Sentenceformation(this.id,this.value)' value='"+val+"'>"+val+"</button>  ";
			bs +=b;
			btncount++;
		}
...
function Experiments(){
	...
	select.innerHTML = "<select id='lang' onchange = 'dropdownoptions()'><option value='select'>---Select Language---</option><option value='english'>English</option><option value='hindi'>Hindi</option></select>";
	seldesc.innerHTML = "";
	desc3.innerHTML = "";
	desc.innerHTML = "";
	desc2.innerHTML = "";
