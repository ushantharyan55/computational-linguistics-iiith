...
function Stemmerfn() {
  ...
  var stemstring = '';
  if (x == 'corpus1') stemstring = corpusarray[0];
  if (x == 'corpus2') stemstring = corpusarray[1];
  if (x == 'corpus3') stemstring = corpusarray[2];
...
function Continuebutton() {
  ...
  answer.innerHTML =
    "<center><button id='submit1' value='Submit' onclick='Stemmerfn()'>Submit</button></center>";
}
...
function Verification() {
  ...
  if (wordcount == tokens && uniquewordcount == types) {
    answer.innerHTML =
      "<center><font color='Green' style = 'font-size:20px'>Right answer</font><br><br><button id='continue' onclick='Continuebutton()'>Continue</button></center>";
  } else {
    answer.innerHTML =
